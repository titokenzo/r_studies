...
#------------------------------------------------------------------------------
animais <- c("Zebra","Patera","Rinoceronte","Macaco","Tigre")
animais
class(animais)
...
str(df)
# OBS.: No exemplo, utilizando o R v3, os tipos categóricos foram reconhecidos como Factor
# Na minha execução com o R v4, os tipos foram character, então fiz a conversão:
#------------------------------------------------------------------------------
...
# Plot
# Agora se fizermos um plot, temos um boxplot pare estas variáveis categóricas
#------------------------------------------------------------------------------
plot(df$Idade~df$Etnia, xlab="Etnia", ylab="Idade", main="Idade por Etnia")

# Regressão (Linear Model)
#------------------------------------------------------------------------------
summary( lm(Idade~Etnia, data=df) )

# Copiando uma coluna e convertendo em variável categórica. Isso criará um fator não-ordenado
df
str(df)
