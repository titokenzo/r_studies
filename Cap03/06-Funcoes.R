...
# A chamada não altera os valores da variável global (passagem de valor)
muda <- function(c){
  c=2
}
c=3
...
# Funções Buint-in - Não tente recriar a roda
...
# Sua máquina pode representar resultado diferente por conta da precisão de cálculo do processador
identical(x2a, x2b)
