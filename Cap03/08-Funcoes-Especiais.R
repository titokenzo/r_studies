...
# A função do.call() aplica ao objeto inteiro, e não a cada elemento individualmente
?do.call
...
dates <- c("1998-05-23", "2008-13-30", "2009-11-29")
temp <- strsplit(dates,"-")
class(temp)
...
frase <- "Muitas vezes temos que repetir algo diversas vezes e essas diversas parecem algo estranho"
