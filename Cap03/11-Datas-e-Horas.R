...
# %y: ano em 2 dígitos (79)
# %Y: ano em 4 dígitos (1979)
# %A: dia da semana (Friday/sexta-feira)
# %a: dia da semana abreviado (Fri/sex)
# %B: mês (July/jUlho)
# %b: mês abreviado (JUl)
...
# Formatando a saída - as.Date() **Cuidado com o idioma!**
#------------------------------------------------------------------------------
as.Date("2018-06-28")
...
# A linguagem R considera o ponto de início a data de 1 de janeiro de 1970 e contabiliza o total
...
# Poderíamos usar aqui apenas POSIXct, que é subclasse (mas não podemos usar apenas a classe principal)
...
# Cria um objeto que especifica a data de início e a data de fim
