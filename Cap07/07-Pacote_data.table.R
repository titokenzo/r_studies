...
# É um pacote que implementa data.frame de forma mais performática
#------------------------------------------------------------------------------
...
# O parâmetro .SD significa "Subset Data", e um subset é criado considerando
# a coluna é calculada a mediana. 
