...
# Matriz: possui 2 dimensões e 1 tipo de dados (elementos,qtde de linhas)
# Os elementos serão distribuídos nas linnhas (devem ser múltiplos)
#------------------------------------------------------------------------------
...
# Array: possui 2 ou mais dimensões e 1 tipo de dado (elementos,dimensões)
# Os elementos serão distribuídos nas dimensões (serão repetidos se não forem suficientes)
#------------------------------------------------------------------------------
