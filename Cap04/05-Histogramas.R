...
# Histograma (útil em estatística descritiva)
# É usado para apresentar a distribuição de frequência de uma variável
# Divide os dados em classes/beans/breaks
# e conta a quantidade de elementos em cada uma
# Não é um gráfico de coluna!
#------------------------------------------------------------------------------
